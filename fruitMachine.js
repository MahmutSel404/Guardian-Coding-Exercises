...
let user_credit = 20; //initial credit of user
let play_credit = 20; //cost of a play
...
for (let i = 0; i < 100; i++) {
  if (user_credit >= play_credit * coefficient) {
    user_credit = user_credit - play_credit * coefficient;
    money_in_machine = money_in_machine + play_credit * coefficient;
    ...
    console.log('3>>>', user_credit, money_in_machine, no_of_free_play);
  }
}
